...
const FlyOutLink = ({
  ...
  return (
    <div
      className="relative w-fit h-fit 2xl:flex xl:flex hidden flex-row items-center justify-center space-x-2 cursor-pointer"
      ...
      <AnimatePresence>
        {showFlyOutContent && (
          <motion.div
            ...
            className="absolute z-20 -left-10 top-10 bg-gray-300 text-black rounded-lg">
