        ...
        <div className="flex flex-col items-start justify-start 2xl:flex-row 2xl:items-start 2xl:justify-between xl:flex-row xl:items-start xl:justify-between">
          <div className="flex flex-col items-start justify-start space-y-3">
            <span className="text-2xl font-bold ">
              {recommendationBlockTitle && recommendationBlockTitle}
            </span>
            <span className="text-lg">
              Type: {accommodationTypeName && accommodationTypeName}
            </span>
            <div className="flex flex-col items-start justify-start space-y-2">
              <span>Check in date: {arrivalDate && arrivalDate}</span>
              <span>Check out date: {departureDate && departureDate}</span>
            </div>
