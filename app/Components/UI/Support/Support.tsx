...
const Support = () => {
  return (
    <div className="flex 2xl:flex-row 2xl:items-center 2xl:justify-center 2xl:space-x-44 2xl:space-y-0 xl:flex-row xl:items-center xl:justify-center xl:space-x-40 xl:space-y-0 lg:flex-row lg:items-center lg:justify-center lg:space-x-24 lg:space-y-0 md:flex-col md:items-center md:justify-center md:space-x-0 md:space-y-20 ls:flex-col ls:items-center ls:justify-center ls:space-x-0 ls:space-y-20 ms:flex-col ms:items-center ms:justify-center ms:space-x-0 ms:space-y-20">
      <div className="w-[22rem] 2xl:w-96 xl:w-96 lg:w-96 md:w-96 h-60 bg-gray-300 p-10 shadow-lg rounded-xl">
